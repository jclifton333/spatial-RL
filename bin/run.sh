#!/usr/bin/env bash
python3 ../src/run/run.py --env_name='sis' --policy_name='one_step_mb' --argmaxer_name='quad_approx' \
...
# python3 ../src/run/run.py --env_name='sis' --policy_name='two_step_mb' --argmaxer_name='quad_approx' \
