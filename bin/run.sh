...
# python3 ../src/run/run.py --env_name='sis' --policy_name='no_action' --argmaxer_name='quad_approx' \
#      --omega=0.0 --number_of_replicates=1 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
#      --evaluation_budget=100 --epsilon=1.0

# python3 ../src/run/run.py --env_name='sis' --policy_name='treat_all' --argmaxer_name='quad_approx' \
#      --omega=0.0 --number_of_replicates=1 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
#      --evaluation_budget=100 --epsilon=1.0
