#!/usr/bin/env bash
python3 ../src/run/run.py --env_name='Ebola' --policy_name='one_step' --argmaxer_name='random' \
     --omega=0.0 --number_of_replicates=1 --rollout_depth=1 --time_horizon=50 --L=300 --gamma=0.9 \
