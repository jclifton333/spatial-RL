#!/usr/bin/env bash
python3 ../src/run/run.py --env_name='Ebola' --policy_name='no_action' --argmaxer_name='random' \
     --omega=0.0 --number_of_replicates=50 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
     --evaluation_budget=100 --epsilon=0.0

python3 ../src/run/run.py --env_name='Ebola' --policy_name='random' --argmaxer_name='random' \
     --omega=0.0 --number_of_replicates=50 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
     --evaluation_budget=100 --epsilon=0.0
