...
python3 ../src/run/run.py --env_name='sis' --policy_name='one_step' --argmaxer_name='quad_approx' \
     --omega=0.0 --number_of_replicates=24 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
     --evaluation_budget=100 --epsilon=1.0 --network='lattice' --seed=5 --error_quantile=0.95 --ignore_errors='True' \
     --learn_embedding='True' --save_features='False' --raw_features='False'

python3 ../src/run/run.py --env_name='sis' --policy_name='one_step' --argmaxer_name='quad_approx' \
     --omega=0.0 --number_of_replicates=24 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
     --evaluation_budget=100 --epsilon=1.0 --network='nearestneighbor' --seed=5 --error_quantile=0.95 --ignore_errors='True' \
     --learn_embedding='True' --save_features='False' --raw_features='False'
...
python3 ../src/run/run.py --env_name='sis' --policy_name='one_step' --argmaxer_name='quad_approx' \
     --omega=0.0 --number_of_replicates=24 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
     --evaluation_budget=100 --epsilon=1.0 --network='contrived' --seed=5 --error_quantile=0.95 --ignore_errors='True' \
     --learn_embedding='True' --save_features='False' --raw_features='False'
...
# python3 ../src/run/run.py --env_name='Ebola' --policy_name='two_step_ggcn' --argmaxer_name='quad_approx' \
#      --omega=0.0 --number_of_replicates=24 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
#      --evaluation_budget=100 --epsilon=0.0 --network='contrived' --seed=5 --error_quantile=0.95 --ignore_errors='True' \
#      --learn_embedding='True' --save_features='False' --raw_features='False'
# 
...
#      --omega=0.0 --number_of_replicates=24 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
#      --evaluation_budget=100 --epsilon=0.0 --network='contrived' --seed=5 --error_quantile=0.95 --ignore_errors='True' \
#      --learn_embedding='True' --save_features='False' --raw_features='True'

# python3 ../src/run/run.py --env_name='sis' --policy_name='two_step_true_probs' --argmaxer_name='quad_approx' \
#      --omega=0.0 --number_of_replicates=24 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
#      --evaluation_budget=100 --epsilon=1.0 --network='contrived' --seed=5 --error_quantile=0.95 --ignore_errors='True' \
#      --learn_embedding='True' --save_features='False' --raw_features='False'
