#!/usr/bin/env bash
python3 ../src/run/run.py --env_name='sis' --policy_name='one_step' --argmaxer_name='random' \
     --omega=0.0 --number_of_replicates=12 --rollout_depth=1 --time_horizon=25 --L=100 --gamma=0.9 \
