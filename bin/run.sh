...
python3 ../src/run/run.py --env_name='sis' --policy_name='one_step' --argmaxer_name='oracle_multiple_quad_approx' \
     --omega=0.0 --number_of_replicates=1 --rollout_depth=1 --time_horizon=25 --L=300 --gamma=0.9 \
...
# python3 ../src/run/run.py --env_name='sis' --policy_name='one_step' --argmaxer_name='multiple_quad_approx' \
