#!/usr/bin/env bash
python3 ../src/run/generate_bootstrap_dbns.py --env_name='SIS' --policy_name='SIS_model_based' --argmaxer_name='quad_approx' \
    --number_of_replicates=1 --omega=0.0 --rollout_depth=0 --time_horizon=3 --L=9 --gamma=0.9 \
    --num_bootstrap_samples=1 --evaluation_budget=1
