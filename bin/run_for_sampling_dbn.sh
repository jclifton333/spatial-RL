...
python3 ../src/run/run_for_sampling_dbn.py  --omega=0.0 --number_of_replicates=5 --rollout_depth=1 --time_horizon=25 \
      --L=25 --gamma=0.9 --evaluation_budget=100 --epsilon=0.0 --seed=8 --error_quantile=0.95 --ignore_errors='False' \
      --network='lattice' --policy='treat_first' --sampling_dbn_estimator='one_step_bins'
