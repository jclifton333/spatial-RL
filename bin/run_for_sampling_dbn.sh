...
python3 ../src/run/run_for_sampling_dbn.py  --omega=0.0 --number_of_replicates=480 --rollout_depth=1 --time_horizon=25 \
      ...
      --network='lattice' --policy='random' --sampling_dbn_estimator='one_step_eval'
...
python3 ../src/run/run_for_sampling_dbn.py  --omega=0.0 --number_of_replicates=480 --rollout_depth=1 --time_horizon=25 \
      --L=500 --gamma=0.9 --evaluation_budget=100 --epsilon=0.0 --seed=8 --error_quantile=0.95 --ignore_errors='False' \
      --network='lattice' --policy='random' --sampling_dbn_estimator='one_step_eval'

python3 ../src/run/run_for_sampling_dbn.py  --omega=0.0 --number_of_replicates=480 --rollout_depth=1 --time_horizon=25 \
      --L=1000 --gamma=0.9 --evaluation_budget=100 --epsilon=0.0 --seed=8 --error_quantile=0.95 --ignore_errors='False' \
      --network='lattice' --policy='random' --sampling_dbn_estimator='one_step_eval'

python3 ../src/run/run_for_sampling_dbn.py  --omega=0.0 --number_of_replicates=480 --rollout_depth=1 --time_horizon=25 \
      --L=2000 --gamma=0.9 --evaluation_budget=100 --epsilon=0.0 --seed=8 --error_quantile=0.95 --ignore_errors='False' \
