...
# python3 ../src/run/run_for_sampling_dbn.py  --omega=0.0 --number_of_replicates=192 --rollout_depth=1 --time_horizon=10 \
...
python3 ../src/run/run_for_sampling_dbn.py  --omega=0.0 --number_of_replicates=100 --rollout_depth=1 --time_horizon=2 \
      --L=10000 --gamma=0.9 --evaluation_budget=100 --epsilon=0.0 --seed=8 --error_quantile=0.95 --ignore_errors='False' \
      --network='lattice' --policy='random_no_replace' --sampling_dbn_estimator='one_step_var_only' --variance_only='True' \
      --independence_parameter=0.0 --parametric_bootstrap='False'

# python3 ../src/run/run_for_sampling_dbn.py  --omega=0.0 --number_of_replicates=960 --rollout_depth=1 --time_horizon=10 \
#       --L=40 --gamma=0.9 --evaluation_budget=100 --epsilon=0.0 --seed=8 --error_quantile=0.95 --ignore_errors='False' \
