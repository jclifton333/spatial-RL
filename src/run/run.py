...
VALID_POLICY_NAMES = ['random', 'no_action', 'true_probs', 'true_probs_myopic', 'fqi', 'one_step', 'two_step',
                      'treat_all', 'sis_model_based_one_step', 'two_step_mb',
                      ...
                      'sis_one_step_continuation', 'ebola_aic_one_step', 'sis_one_step_dyna']
POLICY_SEARCH_NAMES = ['policy_search', 'sis_aic_two_step', 'sis_one_step_continuation']
